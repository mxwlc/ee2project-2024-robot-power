# Progress Log
## Initial Idea
So the requirements say we need to use a cascaded controller, with the outerloop as 'speed' and the inner loop as the tilt angle. There are a few things to consider here:
